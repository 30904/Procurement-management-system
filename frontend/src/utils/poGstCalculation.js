/**
 * Purchase order GST — mirrors backend/src/utils/poGstCalculation.js
 */
...
export function supplyTypeLabel(supplyType) {
  if (supplyType === "interstate") return "Inter-state (IGST)";
