...
export default function HsnPMasterModal({ onClose, onSave, initialData }) {
  ...
  async function handleSave() {
    ...
    try {
      ...
      toast.success(isCreate ? "HSN/P record created." : "HSN/P record updated.");
      onClose?.();
    } catch (err) {
      toast.error(err?.data?.message || err?.message || "Failed to save HSN/P record");
    } finally {
      setSaving(false);
    }
  }
  ...
  return createPortal(
    ...
    >
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="hsn-p-modal-title"
      >
        ...
        <div
          ...
          style={{ cursor: "grab" }}
        >
          <span id="hsn-p-modal-title" className="sc-modal-title">
            {isCreate ? "HSN/P Entry" : "Edit HSN/P Entry"}
          </span>
        ...
        <div className="sc-modal-body">
          ...
          <div className="sc-field-grid">
            ...
            />
            <SelectField
              label="Applicable Procurement Type"
