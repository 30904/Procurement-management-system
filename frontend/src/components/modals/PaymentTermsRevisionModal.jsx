...
export default function PaymentTermsRevisionModal({
  open,
  revisionNo,
  defaultProposedBy = "",
  onClose,
  ...
  return createPortal(
    ...
    >
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="payment-terms-revision-title"
      >
        ...
        <div
          ...
          style={{ cursor: "grab" }}
        >
          <span id="payment-terms-revision-title" className="sc-modal-title">
            Revision Info
          </span>
        ...
        <div className="sc-modal-body" style={{ padding: "2.2vh 1.5vw 1.6vh", gap: "1.5vh" }}>
          <div className="sc-field-grid sc-field-grid--2col">
            ...
            <div className="sc-field sc-field--full">
              ...
              <textarea
                className="sc-input"
                style={{ minHeight: "6.4vh", paddingTop: "0.8vh", resize: "vertical" }}
