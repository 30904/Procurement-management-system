...
export default function SacSRevisionHistoryModal({ open, sourceRow, onClose }) {
  const { modalRef, overlayStyle, modalStyle, handleHeaderMouseDown } = useModalDrag();
          ...
          <div className="rl-table-wrap">
            {pageRows.length === 0 ? (
              ...
              <table className="rl-table">
                <thead>
                  <tr>
                    <th style={{ width: "16%" }}>SAC Code</th>
                    <th style={{ width: "31%" }}>Description of Services</th>
                    <th style={{ width: "12%", textAlign: "center" }}>GST Rate %</th>
