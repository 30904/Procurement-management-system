...
function fieldLabel(field) {
  const labels = {
    checklistItem: "Inspection Checklist Item",
    displayOrder: "Order",
    status: "Status",
  };
...
function buildHistoryRows(sourceRow) {
  ...
  const snapshot = {
    checklistId: sourceRow.checklistId,
    checklistItem: sourceRow.checklistItem,
...
export default function InspectionChecklistRevisionHistoryModal({ open, sourceRow, onClose }) {
  const { modalRef, overlayStyle, modalStyle, handleHeaderMouseDown } = useModalDrag();
    ...
    <>
      ...
      >
        <div
          ...
          style={{ ...modalStyle, width: "72vw", maxWidth: "1000px", height: "68vh", minHeight: "460px" }}
        >
          <div className="sc-modal-bar" />
          <div className="sc-modal-header" onMouseDown={handleHeaderMouseDown} style={{ cursor: "grab" }}>
          ...
          <div className="rl-table-wrap">
            {pageRows.length === 0 ? (
              ...
              <table className="rl-table">
                <thead>
                  <tr>
                    <th style={{ width: "12%" }}>Checklist ID</th>
                    <th style={{ width: "8%", textAlign: "center" }}>Order</th>
                    <th style={{ width: "42%" }}>Inspection Checklist Item</th>
                  ...
                  {pageRows.map((row) => {
                    ...
                    return (
                      <tr key={row.id}>
                        ...
                        <td style={{ textAlign: "center" }}>{row.displayOrder ?? "—"}</td>
