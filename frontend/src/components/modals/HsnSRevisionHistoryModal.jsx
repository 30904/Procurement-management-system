...
function buildHistoryRows(sourceRow) {
  ...
  const snapshot = {
    hsnCode: sourceRow.hsnCode,
    description: sourceRow.description,
    gstRate: sourceRow.gstRate,
    igstRate: sourceRow.igstRate,
    sgstRate: sourceRow.sgstRate,
    cgstRate: sourceRow.cgstRate,
    utgstRate: sourceRow.utgstRate,
        ...
        <div className="sc-modal-body" style={{ padding: "2vh 1.5vw", gap: "1.2vh" }}>
          <div className="sc-field-grid sc-field-grid--2col">
            ...
            <InputField
              label="Revision Date"
              required
              value={formatDate(revision?.revisionDate)}
              locked
            />
          ...
          <div>
            <div className="sc-label" style={{ marginBottom: "0.8vh" }}>Changed Fields</div>
...
export default function HsnSRevisionHistoryModal({ open, sourceRow, onClose }) {
  const { modalRef, overlayStyle, modalStyle, handleHeaderMouseDown } = useModalDrag();
              ...
              <table className="rl-table">
                <thead>
                  <tr>
                    ...
                    <th style={{ width: "12%", textAlign: "center" }}>GST %</th>
                  ...
                  {pageRows.map((row) => {
                    ...
                    return (
                      <tr key={row.id}>
                        ...
                        <td className="rl-rev-num" style={{ textAlign: "center" }}>Rev {row.revNumber}</td>
