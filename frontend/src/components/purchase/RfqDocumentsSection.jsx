...
export default function RfqDocumentsSection({ rfqId, disabled, readOnly = false }) {
    ...
    <section className={styles.sectionPanel}>
      <div className={styles.sectionHeader}>
        <div>
          ...
          <p className={styles.sectionSubtitle}>Technical specifications, drawings, and supporting files</p>
        </div>
      </div>
      <div className={styles.sectionBody}>
        {disabled ? (
          <p className={styles.docHint}>Save the RFQ first to upload documents.</p>
        ) : readOnly ? (
          loading ? (
